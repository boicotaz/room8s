...
function (_React$Component) {
  ...
  function GroupChat(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "submitMessageEnterKey", function (e) {
      if (e.keyCode === 13) {
        ...
        if ($('#searchText').val() != "") {
          ...
          _this.renderNewMessage(messageText); // this.storeNewMessage(messageText);
    ...
    _defineProperty(_assertThisInitialized(_this), "renderNewMessage", function (msgText) {
      var newMsg = {};
      var date = new Date(); // "dd/MM/yyyy hh:mm TT"

      newMsg.userId = _this.state.currentUser.id;
      newMsg.messageText = msgText;
      newMsg.timeSent = date.toLocaleString().replace(",", "").replace(/:.. /, " "); // this.state.scrollToBottom = true;
    ...
    _this.state.currentUser = props.currentUser;
    _this.state.groupMessages = props.groupMessages;
    _this.state.groupDetails = props.groupDetails; // this.state.scrollToBottom = false;
  ...
  _createClass(GroupChat, [{
    ...
    value: function componentDidMount() {
      document.getElementById("searchText").addEventListener("keydown", this.submitMessageEnterKey, false); // document.getElementById("submitButton").addEventListener("onclick", this.submitMessage, false);
    }
  }, {
    ...
    value: function componentDidUpdate() {
      ...
      groupChatBody.scrollTop = groupChatBody.scrollHeight; // this.state.scrollToBottom = false;
      // }
    }
  }, {
    ...
    value: function componentWillUnmount() {
      ...
      document.removeEventListener('newGroupMessageReceived'); // document.getElementById("submitButton").removeEventListener("onclick", this.submitMessage, false);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      console.log("Group Users are__________________________________________", this.state.usersInGroup); // this.state.usersInGroup
      // let messages = 
...
function (_React$Component2) {
  ...
  function Message(props) {
    ...
    _this3 = _possibleConstructorReturn(this, _getPrototypeOf(Message).call(this, props));

    _defineProperty(_assertThisInitialized(_this3), "processUsersInGroup", function (usersInGroup) {
      var _usersInGroup2 = _slicedToArray(usersInGroup, 3),
          firstName = _usersInGroup2[0],
          lastName = _usersInGroup2[1],
          userId = _usersInGroup2[2];
    ...
    _this3.state = {};
    _this3.state.message = props.message;
    _this3.state.currentUser = props.currentUser;
    _this3.state.groupDetails = props.groupDetails;
    _this3.state.usersInGroup = props.usersInGroup;
    return _this3;
  }
  ...
  _createClass(Message, [{
    ...
    value: function render() {
      ...
      var date = new Date(message.timeSent).toLocaleString().replace(",", "").replace(/:.. /, " ");
